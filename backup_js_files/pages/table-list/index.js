...
const TableList = () => {
    ...
    return (_jsxs(PageContainer, { children: [contextHolder, _jsx(ProTable, { headerTitle: intl.formatMessage({
                    ...
                    _jsx(CreateForm, { reload: actionRef.current?.reload }, "create"),
                ], request: rule, columns: columns, rowSelection: {
                    onChange: (_, selectedRows) => {
                        setSelectedRows(selectedRows);
                    },
                } }), selectedRowsState?.length > 0 && (_jsxs(FooterToolbar, { extra: _jsxs("div", { children: [_jsx(FormattedMessage, { id: "pages.searchTable.chosen", defaultMessage: "Chosen" }), ' ', _jsx("a", { style: { fontWeight: 600 }, children: selectedRowsState.length }), ' ', _jsx(FormattedMessage, { id: "pages.searchTable.item", defaultMessage: "\u9879" }), "\u00A0\u00A0", _jsxs("span", { children: [_jsx(FormattedMessage, { id: "pages.searchTable.totalServiceCalls", defaultMessage: "Total number of service calls" }), ' ', selectedRowsState.reduce((pre, item) => pre + (item.callNo ?? 0), 0), ' ', _jsx(FormattedMessage, { id: "pages.searchTable.tenThousand", defaultMessage: "\u4E07" })] })] }), children: [_jsx(Button, { loading: loading, onClick: () => {
