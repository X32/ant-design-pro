...
// 生产环境：直接使用远程 API 地址
// export const API_BASE_URL = isDev ? '' : 'https://www.speakcube.cn';
// const API_BASE_URL = 'https://www.speakcube.cn';
// export const API_BASE_URL = 'https://www.speakcube.cn';
...
export const API_ENDPOINTS = {
  ...
  FEEDBACK_MY_LIST: `${API_BASE_URL}/api/auth/feedback/my`,
  FEEDBACK_DETAIL: `${API_BASE_URL}/api/auth/feedback`, // 动态拼接 /{feedback_id}
