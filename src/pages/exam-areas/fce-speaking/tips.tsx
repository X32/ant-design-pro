    ...
    <ExamAreaLayout examType="FCE">
      ...
      <div className="exam-info-page">
        <Card className="info-card">
          ...
          <Alert
            message="备考建议"
            description="FCE考试重点考察基础英语能力，建议考生每天坚持练习15-20分钟，持续2-3个月即可看到明显进步。"
            type="info"
            showIcon
