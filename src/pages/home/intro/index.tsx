  ...
  return (
    <div className="exam-intro-container">
      <Helmet>
        ...
        />
        <link rel="canonical" href="https://www.speakcube.cn/home/intro" />

        {/* Open Graph */}
        <meta property="og:type" content="article" />
        <meta
          property="og:title"
          content="KET/PET/FCE口语考试介绍 - SpeakCube"
        />
        <meta
          property="og:description"
          content="详细介绍KET、PET、FCE口语考试流程、评分标准、题型结构"
        />
        <meta property="og:url" content="https://www.speakcube.cn/home/intro" />
        <meta
          property="og:image"
          content="https://www.speakcube.cn/og-image-exam-intro.jpg"
        />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            description:
              '详细介绍 KET、PET、FCE 口语考试流程、评分标准、题型结构。了解剑桥英语口语考试评分维度，掌握考试要点，助你顺利通关！',
            author: {
              '@type': 'Organization',
              name: 'SpeakCube',
            ...
            url: 'https://www.speakcube.cn/home/intro',
            mainEntityOfPage: {
              '@type': 'WebPage',
              '@id': 'https://www.speakcube.cn/home/intro',
            },
            articleSection: '考试介绍',
            keywords: [
              'KET 口语考试',
          ...
          <Timeline className="exam-timeline">
            ...
            >
              <div className="timeline-content">
                ...
                <Paragraph>
                  <strong>你的回合：</strong>
                  考官会给你两张照片，要求你围绕照片发言 1
                  分钟；随后考官会向你的搭档提问关于这两张照片的问题，搭档需简要作答。
                </Paragraph>
                <Paragraph>
                  <strong>搭档的回合：</strong>
                  考官会给你的搭档两张不同的照片，搭档围绕这些照片发言 1
                  分钟；这次考官会向你提问关于搭档照片的问题，你需简要作答。
                </Paragraph>
              </div>
            </Timeline.Item>
          ...
          <div className="scoring-items">
            <div className="scoring-item">
              ...
              <ul className="scoring-points">
                <li>
                  <strong>语法准确度：</strong>用正确语法结构表意
                </li>
                <li>
                  <strong>词汇运用：</strong>词汇广泛准确、灵活表达观点
                </li>
              </ul>
            </div>
            ...
            <div className="scoring-item">
              ...
              <ul className="scoring-points">
                <li>
                  <strong>主题关联性：</strong>内容紧扣主题
                </li>
                <li>
                  <strong>连贯流畅：</strong>用连接词 / 过渡句保持语言流畅
                </li>
              </ul>
            </div>
            ...
            <div className="scoring-item">
              ...
              <ul className="scoring-points">
                <li>
                  <strong>清晰度和准确度：</strong>发音清晰、无明显错误
                </li>
                <li>
                  <strong>语调和韵律：</strong>语调自然、语速适中、有韵律感
                </li>
              </ul>
            </div>
            ...
            <div className="scoring-item">
              ...
              <ul className="scoring-points">
                <li>
                  <strong>主动交流：</strong>积极参与对话、提问 / 回应
                </li>
                <li>
                  <strong>维持展开交流：</strong>通过有效交流达成共识
                </li>
              </ul>
            </div>
            ...
            <div className="scoring-item highlight">
              ...
              <ul className="scoring-points">
                <li>
                  <strong>综合表现：</strong>涵盖流利度、语言组织能力、互动效果
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="scoring-formula">
            ...
            <div className="formula-items">
              <div className="formula-item">
                ...
                <Text>
                  每项满分 5 分，<Text mark>× 2</Text> 计入总分
                </Text>
              </div>
              <div className="formula-item">
                <Text strong>整体表现：</Text>
                <Text>
                  满分 5 分，<Text mark>× 4</Text> 计入总分
                </Text>
              </div>
